 ...
 * @author Caroline
 */
public class UpdatePasswordGui extends javax.swing.JFrame {

   /**
    * Creates new form UpdatePasswordGui
    */
   ...
   public static void main(String args[]) {
      ...
      try {
         ...
         java.util.logging.Logger.getLogger(UpdatePasswordGui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
      ...
      java.awt.EventQueue.invokeLater(new Runnable() {
         public void run() {
            new UpdatePasswordGui().setVisible(true);
         }
      });
   }
